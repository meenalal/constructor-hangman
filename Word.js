...
var Word = function(myWord) {
    //Take choosen word from word list.
    this.myWord = myWord;
    //This is an array of letters representing the number of the random chosen word.
    this.letters = [];
    ...
    this.underscores = [];
    //After we get a random word from the word list, I think I need to use the split method to add the letters to this.letters array.
    this.splitWord = function() {
        ...
        //Create for loop that pushes the underscores to this.underscores array in Word constructor.
    ...
    //Export the Word constructor so that we can use/reference it in inde.js.
    module.exports = Word;
