...
//This constructor should be able to either display on underlying character or a blank placeholder (such as an underscore),
...
// A function that returns the underlying character if the letter has been guesssed, or a placeholder (like an underscore) if the letter has not been guessed
// A function that takes a character as an argument and checks it against the underlying character, updating the stored boolean value to true if it was guessed correctly

var Letter = function(character) {
    // A string value to store the underlying character for the letter
    this.character = character.toUpperCase();
    // A boolean value that stores whether that letter has not been guessed yet
